...
<img src="images/02_enable_oem_unlocking_and_usb_debugging_thumb.png" alt="Check product name and model name from settings' about menu" style="width:33%; height:auto;">  

[![Watch the video](images/02_enable_oem_unlocking_and_usb_debugging_thumb.png)](images/02_enable_oem_unlocking_and_usb_debugging_1000kbps_encoded.mp4)
